			...
			<div id="content">
				<div id="bbsData">
					<div class="page-body">
						...
						<form id="siteUpdateFrm" name="siteUpdateFrm" action="siteUpdate" method="post" autocomplete="off" style="height: 1800px; position: relative; top: 100px; left: 270px;">
						...
						<div class="listBtn">
							<button class="list site_Delete">삭제</button>
							<button class="list site_Update">수정</button></a>
							<a href="siteReview"><button class="list ">목록</button></a>
						</div>
						<table>
							<tr>
